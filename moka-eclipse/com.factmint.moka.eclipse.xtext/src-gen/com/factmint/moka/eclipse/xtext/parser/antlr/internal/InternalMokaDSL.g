...
(this_STRING_4=RULE_STRING
    ...
    |this_IMPLICIT_DECIMAL_6=RULE_IMPLICIT_DECIMAL
    { 
...
entryRuleMethodVariable returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMethodVariableRule()); }
	 iv_ruleMethodVariable=ruleMethodVariable 
	 { $current=$iv_ruleMethodVariable.current; } 
	 EOF 
;

// Rule MethodVariable
ruleMethodVariable returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
